...
<link rel="shortcut icon" href="<?php echo base_url();?>webadmin/front/assets/images/favicon.png" />
...
<meta name="twitter:image" content="<?php echo base_url();?>webadmin/front/i1.fnp.sg/images/ban/l/banner-default.jpg" />
<meta property="og:image" content="<?php echo base_url();?>webadmin/front/i1.fnp.sg/images/ban/l/banner-default.jpg"/>
...
<link rel="stylesheet" href="<?php echo base_url();?>webadmin/front/css/bootstrap.min.css">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
<script src="<?php echo base_url();?>webadmin/front/js/bootstrap.min.js"></script>
<style>
	@font-face {
		font-family: 'Roboto';
	...
	.productlisting .infobar>span::before {
		...
		width: 23px;
		height: 15px;
		background: url("<?php echo base_url();?>webadmin/front/assets/images/iconSpriteBg.png") -550px 0px no-repeat;
		vertical-align: middle;
		display: inline-block;
	}
	...
	h1::before, h1::after {
		...
		height: 1px;
		width: 137px;
		background: url("<?php echo base_url();?>webadmin/front/assets/images/iconSpriteBg.png") no-repeat -6px -542px;
		vertical-align: middle;
	}
	h1::after {
	...
	*, *:before, *:after {
	...
	#subscribeform>input[type=email] {
		...
		background: url("<?php echo base_url();?>webadmin/front/assets/images/iconSpriteBg.png") 16px -776px no-repeat;
		background-color: #fff;
	...
	#localitypicker .localityText {
		...
		text-align: left;
		color: #000;
		background: url(<?php echo base_url();?>webadmin/front/assets/images/select-dropdown-icon.png) no-repeat right;
	}
	#localitycontainer {
		height: 32.5%;
		position: absolute;
...
<link rel="stylesheet" href="<?php echo base_url();?>webadmin/front/i1.fnp.sg/assets/topbar/src/css/common.css" type="text/css"/>
<link rel="stylesheet" href="<?php echo base_url();?>webadmin/front/i1.fnp.sg/assets/css/fnp.css" type="text/css"/>
<style>
	@font-face {
		font-family: 'Roboto';
		font-weight:400;
	...
	*, *:before, *:after {
	...
	.emailinput .red-info-icon {
		height: 20px;
		width: 20px;
		background: url(<?php echo base_url();?>webadmin/front/assets/images/rounded-info-red.html) no-repeat 98%
			center;
		z-index: 1111;
	}
	...
	.emailinput .create-error-icon {
		height: 20px;
		width: 15px;
		background: url(<?php echo base_url();?>webadmin/front/assets/images/pencil-edit-red.html) no-repeat 98% center;
		z-index: 1111;
	}
	...
	.emailinput .create-icon {
		height: 20px;
		width: 15px;
		background: url(<?php echo base_url();?>webadmin/front/assets/images/pencil-edit-button.html) no-repeat 98%
			center;
		z-index: 1111;
	}
	...
	#subscribeform>input {
		...
		padding: 10.5px 6.67px 6.67px 39.64px;
		background:
			url(<?php echo base_url();?>webadmin/front/assets/images/simpee-footer-sprite.html) -210px
			10px no-repeat;
		background-color: #fff;
		border: 1px solid #a3a5a6;
		border-right-width: 0px;
	...
	#socialtoolbar>img {
		...
		height: 30px;
		background:
			url(<?php echo base_url();?>webadmin/front/assets/images/simpee-footer-sprite.html) 0 0
			no-repeat;
	}
	...
	**/
	...
	.left-pagination::after {
		width: 16px;
		height: 20px;
		background: url(<?php echo base_url();?>webadmin/front/assets/images/iconSpriteArrows.html) no-repeat;
...
<script>
	...
	var cdnHost = "<?php echo base_url();?>webadmin/front/i1.fnp.sg/";
...
<link href="<?php echo base_url();?>webadmin/front/i1.fnp.sg/assets/min/common.css" rel="stylesheet">
<link href="<?php echo base_url();?>webadmin/front/i1.fnp.sg/assets/min/microsite.css" rel="stylesheet">
<meta name="generator" content="Apache OFBiz"/>
<link href="<?php echo base_url();?>webadmin/front/css/responsiveslides.css" rel="stylesheet">
<link href="<?php echo base_url();?>webadmin/front/css/themes.css" rel="stylesheet">
<link href="<?php echo base_url();?>webadmin/front/css/font-awesome.css" rel="stylesheet">
<style>
			ul {
				margin: 0;
			}
		   ...
		   .occassions.brithen li {
			...
			.occassions li figure span.occasionlist {
				background: url(<?php echo base_url();?>webadmin/front/assets/images/custom/new-home-page/icons/Top-Icons-17-16-oct-2019.svg);
				display: block;
				margin: 0 auto;
				background-repeat: no-repeat;
				background-size: 750%;
			...
			.recipients {
				background: url(<?php echo base_url();?>webadmin/front/assets/images/custom/new-home-page/icons/reciepients.svg);
				display: block;
				margin: 0 auto;
				background-repeat: no-repeat;
				background-size: 750%;
		...
		<link rel="stylesheet" href="<?php echo base_url();?>webadmin/front/css/datepicker.css" type="text/css" />  