	...
	<script src="<?php echo base_url();?>webadmin/front/i1.fnp.sg/assets/js/custom/jQuery.loadScroll.js" defer></script>
				...
				<ul class="medium-block-grid-3">
					<li id="subscribe" data-equalizer-watch>
						...
						<form id="subscribeform" name="subscribeform" class="form-grid" data-ng-controller="FormCntrl as app" novalidate data-ng-submit="subscribeform.$valid && app.subscribe()">
							...
							<div data-ng-cloak data-alert="" class="success alert-box alert alert-bottom" data-ng-if="subscribeform.$valid && subscribeform.$submitted && app.subscribesuccess"> {{app.subscribemsg}} </div>
							<div data-ng-cloak data-alert="" class="error alert-box alert alert-bottom" data-ng-if="subscribeform.$valid && subscribeform.$submitted && app.subscribefail"> {{app.subscribemsg}} </div>
							<button type="submit" class="btn postfix" data-ga-title='SUBMIT'>SUBMIT</button>
						</form>
					</li>

					<li id="securetransactions" style="min-width: 423px;">
						<img class="smily" src="<?php echo base_url();?>webadmin/front/assets/images/footer-smily.png" alt="Smily">
					...
					<li id="socialtoolbar">
						...
						<ul>
							...
							<img src="<?php echo base_url();?>webadmin/front/assets/images/iconSpriteBg.png" alt="Connect with Facebook" /></a>
							
							</li>

							<li>
								<a href="#" target="_blank" id="tw" data-ga-title='Connect with Twitter'>
							<img src="<?php echo base_url();?>webadmin/front/assets/images/iconSpriteBg.png" alt="Connect with Twitter" />
							</a>
							
							</li>
							<li>
								<a href="#" target="_blank" id="pt" data-ga-title='Connect with Pintrest'><img src="<?php echo base_url();?>webadmin/front/assets/images/iconSpriteBg.png" alt="Connect with Pintrest" />
							</a>
							</li>
						</ul>
					</li>
					<li id="securetransactions">
						...
						<div class="payopt">
							<img src="<?php echo base_url();?>webadmin/front/assets/images/icon-payment.png" alt="Visa, MasterCard, Discover, Paypal, American Express Logos"/> </div>
						<div class="walletopt"> <img src="<?php echo base_url();?>webadmin/front/assets/images/wallets-option.png" alt="MobiKwik Airtel Paytm Oxygen PayUMoney"/> </div>
					</li>
...
<script src="<?php echo base_url();?>webadmin/front/i1.fnp.sg/assets/min/common.js"></script>

<script src="<?php echo base_url();?>webadmin/front/i1.fnp.sg/v100/assets/min/product.js"></script>

<script src="<?php echo base_url();?>webadmin/front/i1.fnp.sg/v100/assets/min/microsite.js"></script>
...
<script src="<?php echo base_url();?>webadmin/front/js/responsiveslides.js"></script>
...
<script src="<?php echo base_url();?>webadmin/front/js/datepicker.js"></script>
    <script>
        /*(function($) {
            $(function() {
