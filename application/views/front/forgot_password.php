	...
	<div class="commonformbox login mg-top mg-bottom">
		...
		<div>
			...
			<div class="alert alert-success alert-dismissable">
			  ...
			  <strong>Success! <?php echo $this->session->flashdata('succmsg');?></strong> 					
			</div>
		<?php } ?>
		...
		<form action="<?php echo base_url('welcome/forgot_data');?>" method="post">
			<div class="fieldrow">
			...
			<div class="fieldrow">
				...
				<span class="newuser">Already Member? <a href="<?php echo base_url();?>login" class="forgot" style="margin-left: 2px;">Login</a></span>
