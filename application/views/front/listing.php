...
<main>
		...
		<div class="columns">
			...
			<section class="listing-cont" id="default">
				<ul style="width:100%;">
					...
					<li>
						<a href="<?php echo base_url('item-detail?sl='.$row['item_slug']);?>">
							<img class="pro-photo" src="<?php echo base_url().'img.php?img=item_image/'.$row['item_image'];?>&amp;mode=cm&amp;w=270&amp;h=270" alt="<?php echo $row['item_name'];?>" title="<?php echo $row['item_name'];?>">
				 ...
				 <?php endforeach;
					...
					No Records Founds In <?php echo $sub_cat_name;?>
	...
	<div class="header-wrapper" style="float: left; width: 100%;">
		...
		<div class="category_description">
			<h1 class="plp_heading">Flowers Delivery Indonesia</h1>
		...
		<div class="category_promo">
			<ul class="tiles top_banners">
				<li style="margin-bottom: 30px;"><a href="<?php echo base_url('occasion?sl=birthday-indonesia');?>">
					<img src="<?php echo base_url();?>webadmin/front/assets/images/custom/categories/flowers/Birthday-Flower-21-aug-2019.jpg" alt="Birthday Flowers">
					</a>
				</li>

				<li style="margin-bottom: 30px;">
					<a href="<?php echo base_url('occasion?sl=anniversary-indonesia');?>">
						<img src="<?php echo base_url();?>webadmin/front/assets/images/custom/categories/flowers/Anniversary-Flower-21-aug-2019.jpg" alt="Anniversary Flowers Online">
					</a>
				</li>

				<li style="margin-bottom: 30px;">
					<a href="<?php echo base_url('flowers?sl=rose-indonesia');?>">
					<img src="<?php echo base_url();?>webadmin/front/assets/images/custom/categories/flowers/Roses-21-aug-2019.jpg" alt="Rose Flowers">
					</a>
				</li>
				<li>
					<a href="<?php echo base_url('category?sl=flower-combos-indonesia');?>">
						<img src="<?php echo base_url();?>webadmin/front/assets/images/custom/categories/flowers/Flower-Combo-21-aug-2019.jpg" alt="Tulip Flowers">
					</a>
				</li>
			</ul>
		</div>
...
<script type="text/javascript">
	function short_by(elm){
		var sl = '<?php echo $this->input->get('sl');?>';
		 $.ajax({
				type:"POST",
				url:'<?php echo base_url('welcome/item_short_by');?>',
