...
<?php endif; ?>
            ...
            <a class="btn btn-success btn-sm" href="<?php echo base_url('admin/hike_price/update_hike_price');?>"> <i class="ace-icon fa glyphicon-plus white" title="Add Hike Price"></i> Add New </a>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				$i = '1';
					foreach($recordset as $row)
					{
						...
						$editLink = base_url('admin/hike_price/update_hike_price/').$row['id'];
				?>
                <tr id="tr<?php echo $row['id']; ?>">
                  ...
                  <td><?php echo $row['hike_varient']; ?></td>
...
function change_status(id){
	...
	{
		$.ajax({
			url : '<?php echo base_url('admin/hike_price/changestatus/'); ?>',
			type : 'POST',
			data : 'id=' + id,
			//dataType : 'json',
...
function delete_user(id,editID){
	...
	{
		$.ajax({
			url : '<?php echo base_url('admin/hike_price/hike_price_delete/'); ?>',
			type : 'POST',
			data : 'id=' + id,
			//dataType : 'json',
			beforeSend : function(jqXHR, settings ){
