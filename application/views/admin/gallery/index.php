...
<?php endif; ?>
            ...
            <div class="box-header">
              ...
              <a class="btn btn-success btn-sm" href="<?php echo base_url('admin/gallery/add_gallery'); ?>"> <i class="ace-icon fa glyphicon-plus white" title="Add User"></i>Add New </a>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				$i = '1';
					foreach($recordset as $row)
					{
						...
						$editLink = base_url('admin/gallery/add_gallery/').$row['id'];
				?>
                <tr id="tr<?php echo $row['id']; ?>">
                  <td><?php echo $i; ?></td>
                 
                  <td><img src="<?php echo base_url().'img.php?img=gallery/'.$row['image'];?>&amp;mode=cm&amp;w=100&amp;h=60"></td>
...
function change_status(id){
	...
	{
		$.ajax({
			url : '<?php echo base_url('admin/gallery/changestatus/'); ?>',
			type : 'POST',
			data : 'id=' + id,
			//dataType : 'json',
