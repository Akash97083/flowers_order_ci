...
<?php endif; ?>
            ...
            <div class="box-header">
              ...
              <!-- <a class="btn btn-success btn-sm" href="<?php //echo base_url('admin/cms/add_cms'); ?>"> <i class="ace-icon fa glyphicon-plus white" title="Add User"></i> Add New </a> -->
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				$i = '1';
					foreach($recordset as $row)
					{
						...
						$editLink = base_url('admin/city/add_city/').$row['id'];
				?>
                <tr id="tr<?php echo $row['id']; ?>">
                  ...
                  <td><?php echo ($row['delivery_frequency']=='same_day'?'Same Day':''); ?>
                    <?php echo ($row['delivery_frequency']=='next_day'?'Next Day':''); ?>
                    <?php echo ($row['delivery_frequency']=='day_after'?'Day After':''); ?>
                  </td>
                  ...
                  <td>
                  <a class="btn btn-xs btn-info" href="<?php echo $editLink;?>" title="Update City"> <i class="ace-icon fa fa-pencil bigger-120"></i> </a> 
...
function change_status(id){
	...
	{
		$.ajax({
			url : '<?php echo base_url('admin/city/changestatus/'); ?>',
			type : 'POST',
			data : 'id=' + id,
			//dataType : 'json',
