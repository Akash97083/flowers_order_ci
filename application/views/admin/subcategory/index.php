...
<?php endif; ?>
            ...
            <a class="btn btn-success btn-sm" href="<?php echo base_url('admin/subcategory/add_subcategory'); ?>"> <i class="ace-icon fa glyphicon-plus white" title="Add Subcategory"></i> Add New </a>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				$i = '1';
					foreach($recordset as $row)
					{
						...
						$editLink = base_url('admin/subcategory/add_subcategory/').$row['id'];
				?>
                <tr id="tr<?php echo $row['id']; ?>">
                  <td><?php echo $i; ?></td>
                 
                  <td><?php echo getNameTable('tbl_category','category_name','id',$row['cat_id']);
                   ?></td>
...
function change_status(id){
	...
	{
		$.ajax({
			url : '<?php echo base_url('admin/Subcategory/changestatus/'); ?>',
			type : 'POST',
			data : 'id=' + id,
			//dataType : 'json',
