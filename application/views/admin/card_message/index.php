...
<?php endif; ?>
            ...
            <a class="btn btn-success" href="<?php echo base_url('admin/card_message/add_card_message'); ?>" title="Add Card Message"><i class="ace-icon fa glyphicon-plus white"></i> Add New </a>
            ...
            <div class="box-body">
			  ...
			  //print_r($recordset);
				...
				$i = '1';
					...
					{
						$editLink = base_url('admin/card_message/add_card_message/').$row['id'];
				?>
...
function change_status(id){
	...
	{
		$.ajax({
			url : '<?php echo base_url('admin/card_message/changestatus/'); ?>',
			type : 'POST',
			data : 'id=' + id,
			//dataType : 'json',
