...
<?php endif; ?>
            ...
            <div class="box-header">
              ...
              <?php //if(get_permission('17','is_add') == '1'){ ?>
              	<a class="btn btn-success btn-sm" href="<?php echo base_url('admin/testimonials/add_testimonial'); ?>"> <i class="ace-icon fa glyphicon-plus white" title="Add User"></i> Add New </a>
              <?php //} ?>
              </h3>
            </div>
            <!-- /.box-header -->
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				$i = '1';
					foreach($recordset as $row)
					{
						...
						$editLink = base_url('admin/testimonials/add_testimonial/').$row['id'];
				?>
                <tr id="tr<?php echo $row['id']; ?>">
                  <td><?php echo $i; ?></td>
                 
                  <td><img src="<?php echo base_url().'uploads/testimonials/'.$row['image']; ?>" height="60" width="100" ></td>
...
function delete_user(id,editID){
	if(confirm("Are you sure to delete of this Testimonial ?"))
	{
		$.ajax({
			url : '<?php echo base_url('admin/testimonials/testimonial_delete/'); ?>',
			type : 'POST',
			data : 'id=' + id,
			//dataType : 'json',
			beforeSend : function(jqXHR, settings ){
